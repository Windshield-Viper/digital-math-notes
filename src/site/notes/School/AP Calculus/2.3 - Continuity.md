---
{"dg-publish":true,"dg-path":"AP Calculus Notes/2.3 - Continuity.md","permalink":"/ap-calculus-notes/2-3-continuity/","created":"","updated":""}
---
...
**Step 1:** Does $\displaystyle\lim_{ x \to c } f(x)$ exist? 
	(are [[School/AP Calculus/2.1 - Intro to Limits#Whether or not a limit exists\|the left and right hand limits equal?]])
